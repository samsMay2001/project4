    ...
    return ( 
        <div className="col-lg-4  mb-100">
			...
			<div className="widget ltn__menu-widget">
				...
				<ul>
                    <SidebarLabel label={'House'} amount={'3,924'} />
                    <SidebarLabel label={'Single Family'} amount={'3,610'} />
                    <SidebarLabel label={'Apartment'} amount={'2,912'} />
                    <SidebarLabel label={'Office Villa'} amount={'2,687'} />
                    <SidebarLabel label={'Luxary Home'} amount={'1,853'} />
                    <SidebarLabel label={'Studio'} amount={'893'} />
				</ul>
				<hr />
				<h4 className="ltn__widget-title">Amenities</h4>
				<ul>
                    <SidebarLabel label={'Dishwasher'} amount={'3,924'} />
                    <SidebarLabel label={'Floor Coverings'} amount={'3,610'} />
                    <SidebarLabel label={'Internet'} amount={'3,610'} />
                    <SidebarLabel label={'Floor Coverings'} amount={'3,610'} />
                    <SidebarLabel label={'Build Wardrobes'} amount={'2,687'} />
				</ul>
				<hr />
				<h4 className="ltn__widget-title">Price Renge</h4>
				<ul>
                    <SidebarLabel label={'Low Budget'} amount={'$5,000 - $10,000'} />
                    <SidebarLabel label={'Medium'} amount={'$10,000 - $30,000'} />
                    <SidebarLabel label={'High Budget'} amount={'$30,000 Up'} />
				</ul>
			</div>
			{/* Category Widget */}
